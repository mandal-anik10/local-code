...
#DETERMINATION OF THE VALUE OF cos(x) WITH ERROR APPROXIMATION :
...
(i,fact,sum,err,z,tm)=(0,1,1,1,0,0)
...
while (err >= esp):
    ...
    if i % 2 == 0:
        ...
        err = abs(t)
        tm=tm+1
print("\nThe value of the cos(",a,") with maximum error approximation",esp," :\t",sum)
